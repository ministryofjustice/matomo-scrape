...
Using a plain text editor such as _TextEdit_ (on a mac) open the `berwyn_feb_2018.sh` file and add the following remembering to replace 'token12356' with your real PIWIK token
...
> **Note** When using _TextEdit_ make sure that you have set it to plain text mode using `Format > Make Plain Text`.
